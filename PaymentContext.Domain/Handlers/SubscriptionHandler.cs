...
namespace PaymentContext.Domain.Handlers
{
    ...
    public class SubscriptionHandler : Notifiable, IHandler<CreateBoletoSubscriptionCommand>, IHandler<CreatePayPalSubscriptionCommand>
    {
        ...
        public ICommandResult Handle(CreateBoletoSubscriptionCommand command)
        {
            ...
            // Verificar se o documento ja está cadastrado
            if (_repository.DocumentExists(command.Document))
                AddNotification("Document", "Esse cpf ja está em uso");

            // Verificar se o email ja está cadastrado
            if (_repository.EmailExists(command.Document))
                AddNotification("Email", "Esse Email ja está em uso");
            // Gerar os VOs
            ...
            _emailService.Send(student.Name.ToString(), student.Email.EmailAdress, "Bem vindo ao balta.io", "Sua assinatura foi criada");
